...
const routes = [
  ...
  { path: '/about/what-we-do', name: 'about-what-we-do', component: WhatWeDoPage },
  { path: '/about/what-we-do/:slug', name: 'about-what-we-do-detail', component: SubPage, props: true },
  { path: '/about-us/what-we-do', redirect: '/about/what-we-do' },
  { path: '/about-us/what-we-do/:slug', redirect: to => `/about/what-we-do/${to.params.slug}` },
  { path: '/what-we-do', redirect: '/about/what-we-do' },
  { path: '/what-we-do/:slug', redirect: to => `/about/what-we-do/${to.params.slug}` },
...
router.beforeEach((to) => {
  const titles = {
    ...
    'about-what-we-do': 'What We Do | TUMAMCARE',
    'about-what-we-do-detail': 'What We Do | TUMAMCARE',
